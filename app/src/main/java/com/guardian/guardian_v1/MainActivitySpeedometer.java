...
public class MainActivitySpeedometer extends AppCompatActivity {


    LocationService myService;
    static boolean status;
    LocationManager locationManager;
    static TextView dist, time, speed , stoptxt, startStopTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stoptxt = findViewById(R.id.stoptext);
        start = (Button) findViewById(R.id.start);
        pause = (Button) findViewById(R.id.pause);
        stop = (Button) findViewById(R.id.stop);
        startStopTime = findViewById(R.id.startStopTime);
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (status == false)
                    ...
                    bindService();
                locate = new ProgressDialog(MainActivitySpeedometer.this);
